...
<div className="mb-2 flex h-[46px] w-full items-center rounded-xl border border-zinc-200 bg-white px-4 shadow-sm transition focus-within:border-emerald-500/60 dark:border-zinc-800 dark:bg-zinc-900/80 dark:shadow-2xl dark:shadow-black/20">
    <span className="mr-3 text-lg text-zinc-400 dark:text-zinc-500">⌕</span>
    <input type="text" placeholder="Search stock..." onChange={e => setSearch(e.target.value)} className="w-full bg-transparent text-sm text-zinc-900 outline-none placeholder:text-zinc-400 dark:text-white dark:placeholder:text-zinc-600" />
</div>
