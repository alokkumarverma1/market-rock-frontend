...
<input type="text" name="" className="w-full h-full rounded-2xl outline-none border border-gray-300  dark:text-white dark:bg-zinc-800 p-3" placeholder="serch stock" onChange={(e) => setSearch(e.target.value)} />
</div>
