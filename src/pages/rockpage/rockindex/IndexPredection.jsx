...
function IndexPredection({ value = -50 }) {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="w-full max-w-[420px] rounded-3xlbg-white p-5 sm:p-8">
        {/* Gauge */}
        <div className="relative w-full max-w-[320px] aspect-[1.4] mx-auto">
          ...
          <svg viewBox="0 0 320 220" className="absolute inset-0 w-full h-full">
            {/* CALL Side */}
            <path d="M40 170 A120 120 0 0 1 160 50" fill="none" stroke="#22c55e" strokeWidth="18" strokeLinecap="round" />
            {/* PUT Side */}
            <path d="M160 50 A120 120 0 0 1 280 170" fill="none" stroke="#ef4444" strokeWidth="18" strokeLinecap="round"/>
            {/* Neutral Text */}
            <text x="160" y="28" textAnchor="middle" fill="#6b7280" fontSize="14" fontWeight="600">
              NEUTRAL
            </text>
          </svg>
