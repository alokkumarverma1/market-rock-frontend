...
function RockIndexCard({name,color,price ,date,time}){
  
    return(<>
    <div className="rockcard h-50 w-60 transition-shadow justify-between p-3 flex items-center flex-col rounded-2xl shadow-md hover:shadow-xl" style={{backgroundColor:`${color}`}}>
    <h1 className="font-bold">{name}</h1>
    <div className="flex ml-10 mr-10 justify-center flex-col items-center">
