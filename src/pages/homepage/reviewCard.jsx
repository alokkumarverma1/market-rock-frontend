...
function ReviewCard({name , review}){
    return(<>
    <div className="reviewcard p-3 bg-white dark:bg-zinc-800 min-w-60 flex justify-center items-center flex-col text-center shadow-md rounded-2xl ">
     ...
     <h1>{name}</h1>
     <p className="text-[13px] text-zinc-400 mt-4">{review}</p>
